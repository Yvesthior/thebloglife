    ...
    <div class="max-width-1200">
        ...
        <div class="wrapper-list-social-login-options" @if (!setting('social_login_enable')) style="display:none;" @endif>
            <div class="flexbox-annotated-section">
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group mb-3 @if (!setting('social_login_facebook_enable')) mb-0 @endif">
            ...
            <div class="flexbox-annotated-section">
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group mb-3 @if (!setting('social_login_google_enable')) mb-0 @endif">
            ...
            <div class="flexbox-annotated-section">
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group mb-3 @if (!setting('social_login_github_enable')) mb-0 @endif">
            ...
            <div class="flexbox-annotated-section">
                ...
                <div class="flexbox-annotated-section-content">
                    <div class="wrapper-content pd-all-20">
                        <div class="form-group mb-3 @if (!setting('social_login_linkedin_enable')) mb-0 @endif">
