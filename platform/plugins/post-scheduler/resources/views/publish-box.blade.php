<div class="row form-group @if ($errors->has('publish_date')) has-error @endif">
    <label for="publish_date" class="control-label col-sm-3 text-end">{{ trans('plugins/post-scheduler::post-scheduler.date') }}</label>
    <div class="col-sm-9">
...
<div class="row form-group @if ($errors->has('publish_time')) has-error @endif">
    <label for="publish_time" class="control-label col-sm-3 text-end">{{ trans('plugins/post-scheduler::post-scheduler.time') }}</label>
    <div class="col-sm-9">
